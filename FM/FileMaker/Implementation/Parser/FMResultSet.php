...
class FileMaker_Parser_FMResultSet {
	...
	public static function FileMaker_Parser_FMResultSet(&$V0ab34ca9) {
		$this->_fm =& $V0ab34ca9;
	}
	...
	public static function setResult(&$Vb4a88417, $V561b2299 = 'FileMaker_Record') {
		if (!$this->V6de51026) {
	...
	public static function setLayout(&$Vc6140495)
 {
 if (!$this->V6de51026) {
